var generate = () => {
    ...
    document.querySelector("#sign_container1").innerHTML = capchaValue
    document.querySelector("#sign_container1").style["text-decoration"] = 'line-through'
    

    html2canvas(document.getElementById('sign_container1'), {
        onrendered: function (canvas) {
            var screenshot = canvas.toDataURL('image/png');
            document.querySelector('#cptImage').setAttribute('src', screenshot);
            document.querySelector("#sign_container1").style.display = 'none'
        },
    });
}
